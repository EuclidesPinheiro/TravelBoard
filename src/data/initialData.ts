  ...
  travelers: [
    {
      ...
      color: "#9B59B6", // roxo
      segments: [
        { type: 'city', id: uuidv4(), cityName: 'Roma', country: 'IT', startDate: '2026-05-20', endDate: '2026-05-23' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Milão', country: 'IT', startDate: '2026-05-23', endDate: '2026-05-25' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Genebra', country: 'CH', startDate: '2026-05-25', endDate: '2026-05-29' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Zurique', country: 'CH', startDate: '2026-05-29', endDate: '2026-05-31' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Munich', country: 'DE', startDate: '2026-05-31', endDate: '2026-06-03' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Salzburgo', country: 'AT', startDate: '2026-06-03', endDate: '2026-06-04' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Viena', country: 'AT', startDate: '2026-06-04', endDate: '2026-06-07' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Praga', country: 'CZ', startDate: '2026-06-07', endDate: '2026-06-09' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Berlim', country: 'DE', startDate: '2026-06-09', endDate: '2026-06-11' },
      ]
    },
    {
      id: uuidv4(),
      ...
      color: "#3498DB", // azul
      segments: [
        { type: 'city', id: uuidv4(), cityName: 'Copenhagen', country: 'DK', startDate: '2026-05-31', endDate: '2026-06-03' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Viena', country: 'AT', startDate: '2026-06-03', endDate: '2026-06-06' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Praga', country: 'CZ', startDate: '2026-06-06', endDate: '2026-06-08' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Berlim', country: 'DE', startDate: '2026-06-08', endDate: '2026-06-11' },
      ]
    },
    {
      id: uuidv4(),
      ...
      segments: [
        { type: 'city', id: uuidv4(), cityName: 'Frankfurt', country: 'DE', startDate: '2026-06-02', endDate: '2026-06-03' },
    ...
    },
    {
      ...
      color: "#27AE60", // verde
      segments: [
        { type: 'city', id: uuidv4(), cityName: 'Frankfurt', country: 'DE', startDate: '2026-06-01', endDate: '2026-06-02' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Viena', country: 'AT', startDate: '2026-06-02', endDate: '2026-06-06' },
        { type: 'transport', id: uuidv4(), mode: 'train', from: 'Viena', to: 'Praga', departureDate: '2026-06-06', departureTime: '09:00', arrivalDate: '2026-06-06', arrivalTime: '13:00' },
        { type: 'city', id: uuidv4(), cityName: 'Praga', country: 'CZ', startDate: '2026-06-06', endDate: '2026-06-08' },
        { type: 'transport', id: uuidv4(), mode: 'train', from: 'Praga', to: 'Berlim', departureDate: '2026-06-08', departureTime: '10:30', arrivalDate: '2026-06-08', arrivalTime: '15:00' },
        { type: 'city', id: uuidv4(), cityName: 'Berlim', country: 'DE', startDate: '2026-06-08', endDate: '2026-06-11' },
    ...
    },
    {
      ...
      color: "#E84393", // rosa
      segments: [
        { type: 'city', id: uuidv4(), cityName: 'Lisboa', country: 'PT', startDate: '2026-05-20', endDate: '2026-05-25' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Madrid', country: 'ES', startDate: '2026-05-25', endDate: '2026-05-28' },
        ...
        { type: 'city', id: uuidv4(), cityName: 'Berlim', country: 'DE', startDate: '2026-05-28', endDate: '2026-06-11' },
      ]
    }
  ]
};
